...
この fork は、元プロジェクト [Local1stDotApp/XFiles](https://github.com/Local1stDotApp/XFiles) がなければ成り立ちません。

XFiles を作り、オープンソースとして公開してくださった作者・コントリビューターの皆さまに心から感謝します。素晴らしい土台を公開していただいたおかげで、自分の用途に合わせた機能追加や改善を続けることができています。
